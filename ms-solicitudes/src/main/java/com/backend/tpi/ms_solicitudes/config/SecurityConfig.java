...
public class SecurityConfig {
    ...
    JwtDecoder jwtDecoder() {
        ...
        // No validar el issuer - permitir tokens de cualquier issuer
        jwtDecoder.setJwtValidator(token -> org.springframework.security.oauth2.jwt.JwtValidators.createDefault().validate(token));
        return jwtDecoder;
    }
